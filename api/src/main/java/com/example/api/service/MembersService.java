...
public interface MembersService {
  ...
  default Members dtoToEnitity(MembersDTO membersDTO) {
    Set<String> roleSetSafe = membersDTO.getRoleSet() != null ? membersDTO.getRoleSet() : new HashSet<>();
    Members members = Members.builder()
        ...
        .fromSocial(membersDTO.getFromSocial() != null ? membersDTO.getFromSocial() : false)
        .roleSet(roleSetSafe.stream().map(new Function<String, MembersRole>() {
          @Override
