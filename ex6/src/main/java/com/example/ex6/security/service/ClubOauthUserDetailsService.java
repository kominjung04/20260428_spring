package com.example.ex6.security.service;
...
public class ClubOauthUserDetailsService extends DefaultOAuth2UserService {
  ...
  // 1. Social(GOOGLE,NAVER,KAKAO...)에 로그인 정보를 보내고 로그인 결과를 받는다.
  ...
  public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
    ...
    if (result.isPresent()) { // 4. 이미 등록 되어있을 때
      ...
      clubMemberRepository.save(clubMember); //DB 저장
    }
    System.out.println("clientMember" + clubMember);
    // 세션 저장
