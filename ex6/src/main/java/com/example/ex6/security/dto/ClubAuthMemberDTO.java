package com.example.ex6.security.dto;
...
public class ClubAuthMemberDTO extends User implements OAuth2User {
  ...
  public ClubAuthMemberDTO(String username, @Nullable String password, boolean fromSocial,Collection<? extends GrantedAuthority> authorities,Map<String,Object> attr, String email,String name) {
